...
class WebSocketTransport {
  ...
  constructor(progress, url, logUrl, headers, followRedirects, debugLogHeader) {
      ...
      handshakeTimeout: Math.max(
        (_progress$timeUntilDe =
          progress === null || progress === void 0
            ? void 0
            : progress.timeUntilDeadline()) !== null &&
          _progress$timeUntilDe !== void 0
          ? _progress$timeUntilDe
          : 30_000,
        1
      ),
    ...
    this._ws.on = (e, cb) => {
      this._ws.addEventListener(e, cb);
    };
      ...
      messageWrap(() => {
        ...
        try {
          ...
          (_this$_progress = this._progress) === null ||
            ...
            _this$_progress.log(
              `<closing ws> Closing websocket due to malformed JSON. eventData=${eventData} e=${
        ...
        try {
          ...
          (_this$_progress2 = this._progress) === null ||
            ...
            _this$_progress2.log(
              `<closing ws> Closing websocket due to failed onmessage callback. eventData=${eventData} e=${
                e === null || e === void 0 ? void 0 : e.message
              }`
            );
          this._ws.close();
    ...
    this._ws.addEventListener("error", (error) => {
      ...
      return (_this$_progress4 = this._progress) === null ||
        _this$_progress4 === void 0
        ? void 0
        : _this$_progress4.log(
  ...
  async closeAndWait() {
    ...
    const promise = new Promise((f) => this._ws.on("close", f));
    this.close();
